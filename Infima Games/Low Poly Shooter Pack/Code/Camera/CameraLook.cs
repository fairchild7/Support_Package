...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class CameraLook : MonoBehaviour
    {
        ...
        [Tooltip("Minimum sensitivity rate, make sure camera always can rotate")]
        [SerializeField] float minimumSensitivityNormalized = 0.1f;

        [Tooltip("Sensitivity max value")]
        [SerializeField] float sensitivityRange = 5f;
        ...
        [Tooltip("Player camera rotate lookpad.")]
        [SerializeField]
        ...
        private void Awake()
        {
            this.RegisterListener(EventID.OnChangeSensitivity, (param) =>
            {
                OnChangeSensitivity((float)param);
            });
        }
        ...
        private void LateUpdate()
        {
            ...
            Vector2 frameInput = lookpad.TouchInput;
        ...
        public void OnChangeSensitivity(float valueNormalized)
        {
            sensitivity = (minimumSensitivityNormalized + valueNormalized) * sensitivityRange * Vector2.one;
        }
        #endregion
    }
}